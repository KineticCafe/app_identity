defmodule AppIdentity.AppIdentityError do
  ...
  @exception_messages %{
    ...
    plug_missing_apps_or_finder: "AppIdentity.Plug configuration error: one of `apps` or `finder` is required",
    plug_headers_required: "AppIdentity.Plug configuration error: one of `headers` or `header_groups` is required",
    plug_excess_headers:
    ...
    plug_header_groups_invalid: "AppIdentity.Plug configuration error: `header_groups` value is invalid",
    plug_finder_invalid: "AppIdentity.Plug configuration error: `finder` callback is invalid",
    plug_on_failure_invalid: "AppIdentity.Plug configuration error: `on_failure` value is invalid",
    plug_on_failure_callback_invalid: "AppIdentity.Plug configuration error: `on_failure` callback is invalid",
    plug_on_success_invalid: "AppIdentity.Plug configuration error: `on_success` callback is invalid",
    plug_on_resolution_invalid: "AppIdentity.Plug configuration error: `on_resolution` callback is invalid",
    plug_disallowed_invalid: "AppIdentity.Plug configuration error: `disallowed` value is invalid",
